#!/bin/sh
# hello-go-deploy-gke unit-test.sh
...
echo "cd $GOPATH/src/github.com/JeffDeCola/hello-go-deploy-gke/example-01"
cd "$GOPATH/src/github.com/JeffDeCola/hello-go-deploy-gke/example-01"
echo " "
