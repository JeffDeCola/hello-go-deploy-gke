...
echo "The goal is to git clone /hello-go-deploy-gke to /hello-go-deploy-gke-updated"
...
echo "   /hello-go-deploy-gke-updated (created in task-build-push.yml task file)"
echo " "
...
echo "git clone hello-go-deploy-gke to hello-go-deploy-gke-updated"
git clone hello-go-deploy-gke hello-go-deploy-gke-updated
echo " "

echo "cd hello-go-deploy-gke-updated"
cd hello-go-deploy-gke-updated
echo " "
...
echo "    sed -i 's/svgs\//https:\/\/raw.githubusercontent.com\/JeffDeCola\/hello-go-deploy-gke\/master\/svgs\//g' temp-README.md"
sed -i 's/svgs\//https:\/\/raw.githubusercontent.com\/JeffDeCola\/hello-go-deploy-gke\/master\/svgs\//g' temp-README.md
echo " "
