#!/bin/sh
# hello-go-deploy-gke build-push.sh
...
echo "cp -r hello-go-deploy-gke/hello-go-deploy-gke-code/* dist"
cp -r hello-go-deploy-gke/hello-go-deploy-gke-code/* dist
echo " "
...
#echo "cd src/github.com/JeffDeCola/hello-go-deploy-gke/hello-go-deploy-gke-code"
#cd src/github.com/JeffDeCola/hello-go-deploy-gke/hello-go-deploy-gke-code
#echo " "
...
#cp "$GOPATH/src/github.com/JeffDeCola/hello-go-deploy-gke/hello-go-deploy-gke-code/bin/hello-go" .
#echo " "

#echo "cp the Dockerfile into /dist"
#cp "$GOPATH/src/github.com/JeffDeCola/hello-go-deploy-gke/hello-go-deploy-gke-code/build-push/Dockerfile" .
#echo " "
