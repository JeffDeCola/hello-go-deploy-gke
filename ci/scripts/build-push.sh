...
echo "cd src/github.com/JeffDeCola/hello-go-deploy-gke/example-01-gke"
cd src/github.com/JeffDeCola/hello-go-deploy-gke/example-01-gke
echo " "
...
cp "$GOPATH/src/github.com/JeffDeCola/hello-go-deploy-gke/example-01-gke/bin/hello-go" .
echo " "

echo "cp the Dockerfile into /dist"
cp "$GOPATH/src/github.com/JeffDeCola/hello-go-deploy-gke/example-01-gke/build-push/Dockerfile" .
echo " "
